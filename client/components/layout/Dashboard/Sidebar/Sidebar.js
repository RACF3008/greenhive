...
const SideMenu = () => {
  ...
  const toggleSideMenu = () => {
    if (isMenuOpen) {
      setArrowIconClass(`${styles.icon} ${styles.unclicked}`);
      setLabelClass(`${styles.label} ${styles.hidden}`);
    } else {
      setArrowIconClass(`${styles.icon} ${styles.clicked}`);
      setLabelClass(`${styles.label} ${styles.visible}`);
    }
  ...
  return (
    <div className={styles.sideMenu}>
      <nav className={styles.subMenu}>
        <div className={styles.menuItem} onClick={toggleSideMenu}>
          <svg
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 320 512"
